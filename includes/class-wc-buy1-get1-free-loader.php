 ...
 */
class Wc_Buy1_Get1_Free_Loader {
	...
	public function add_shortcode( $hook, $component, $callback ) {
		$this->shortcodes = $this->add_plugin_shortcode( $this->shortcodes, $hook, $component, $callback );
	}
	 ...
	 * @return   array  The collection of actions and filters registered with WordPress.
	 */
	private function add_plugin_shortcode( $hooks, $hook, $component, $callback ) {
		$hooks[] = array(
			'hook'      => $hook,
			'component' => $component,
			'callback'  => $callback,
